...
.method public static bridge synthetic m(Landroid/view/DisplayShape;)Landroid/graphics/Path;
    .locals 0

    .line 0
    invoke-virtual {p0}, Landroid/view/DisplayShape;->getPath()Landroid/graphics/Path;
...
.method public static bridge synthetic m(Landroid/view/Display;)Landroid/view/DisplayShape;
    .locals 0

    .line 0
    invoke-virtual {p0}, Landroid/view/Display;->getShape()Landroid/view/DisplayShape;
...
.method public static bridge synthetic m(Landroid/view/WindowInsets$Builder;ILjava/util/List;)Landroid/view/WindowInsets$Builder;
    .locals 0

    .line 0
    invoke-virtual {p0, p1, p2}, Landroid/view/WindowInsets$Builder;->setBoundingRects(ILjava/util/List;)Landroid/view/WindowInsets$Builder;
...
.method public static bridge synthetic m(Landroid/view/WindowInsets$Builder;Landroid/view/DisplayShape;)Landroid/view/WindowInsets$Builder;
    .locals 0

    .line 0
    invoke-virtual {p0, p1}, Landroid/view/WindowInsets$Builder;->setDisplayShape(Landroid/view/DisplayShape;)Landroid/view/WindowInsets$Builder;
...
.method public static bridge synthetic m$1(Landroid/view/WindowInsets$Builder;ILjava/util/List;)Landroid/view/WindowInsets$Builder;
    .locals 0

    .line 0
    invoke-virtual {p0, p1, p2}, Landroid/view/WindowInsets$Builder;->setBoundingRectsIgnoringVisibility(ILjava/util/List;)Landroid/view/WindowInsets$Builder;

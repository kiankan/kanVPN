...
.method private static copyFileToMediaStore(Ljava/io/File;Landroidx/camera/core/ImageCapture$OutputFileOptions;)Landroid/net/Uri;
    ...
    .line 0
    const-string v1, "Failed to write to MediaStore URI: "
    ...
    .line 170
    invoke-static {v3, v4}, Landroidx/camera/core/imagecapture/FileUtil;->setContentValuePendingFlag(Landroid/content/ContentValues;I)V
    ...
    .line 173
    :try_start_0
    const-string v7, "copyFileToMediaStore: inserting values to MediaStore"
    ...
    .line 175
    :try_start_1
    const-string v3, "copyFileToMediaStore: insert success"
    ...
    .line 180
    invoke-static {p0, p1, v2}, Landroidx/camera/core/imagecapture/FileUtil;->copyTempFileToUri(Ljava/io/File;Landroid/net/Uri;Landroid/content/ContentResolver;)V
    :try_end_1
    ...
    .line 186
    invoke-static {p1, v2, v5}, Landroidx/camera/core/imagecapture/FileUtil;->updateUriPendingStatus(Landroid/net/Uri;Landroid/content/ContentResolver;I)V
    ...
    invoke-direct {p0, v4, v0, v6}, Landroidx/camera/core/ImageCaptureException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, v4, v0, p0}, Landroidx/camera/core/ImageCaptureException;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 186
    invoke-static {v6, v2, v5}, Landroidx/camera/core/imagecapture/FileUtil;->updateUriPendingStatus(Landroid/net/Uri;Landroid/content/ContentResolver;I)V

...
.method private final declared-synchronized completeEdit(Lcoil/disk/DiskLruCache$Editor;Z)V
    ...
    .line 462
    :try_start_2
    invoke-virtual {v5, v2, v3}, Lcoil/disk/DiskLruCache$fileSystem$1;->atomicMove(Lokio/Path;Lokio/Path;)V
    ...
    invoke-static {v5, v2}, Lcoil/util/-FileSystems;->createFile(Lokio/FileSystem;Lokio/Path;)V
...
.method private final declared-synchronized writeJournal()V
    ...
    .line 344
    :try_start_5
    iget-object v0, p0, Lcoil/disk/DiskLruCache;->journalFile:Lokio/Path;

    iget-object v3, p0, Lcoil/disk/DiskLruCache;->journalFileBackup:Lokio/Path;

    invoke-virtual {v1, v0, v3}, Lcoil/disk/DiskLruCache$fileSystem$1;->atomicMove(Lokio/Path;Lokio/Path;)V
    ...
    .line 348
    :cond_5
    iget-object v0, p0, Lcoil/disk/DiskLruCache;->journalFileTmp:Lokio/Path;

...
.method private static final Path(Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, v0}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
...
.method private static final varargs Path(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
...
.method private static final copyTo(Ljava/nio/file/Path;Ljava/nio/file/Path;Z)Ljava/nio/file/Path;
    ...
    invoke-static {p0, p1, p2}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;[Ljava/nio/file/CopyOption;)Ljava/nio/file/Path;
...
.method public static final varargs createParentDirectories(Ljava/nio/file/Path;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/file/Path;
    ...
    invoke-static {v0, v2}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {v0, v1}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method private static final div(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    .line 942
    invoke-static {p0, p1}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method private static final varargs exists(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
    ...
    invoke-static {p0, p1}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m$1(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Z
...
.method public static final getInvariantSeparatorsPathString(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/FileSystem;)Ljava/lang/String;
...
.method private static final varargs synthetic readAttributes(Ljava/nio/file/Path;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
    ...
    invoke-static {}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m$1()Ljava/lang/Class;
    ...
    invoke-static {p0, v0, p1}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/BasicFileAttributes;
...
.method public static final visitFileTree(Ljava/nio/file/Path;Ljava/nio/file/FileVisitor;IZ)V
    ...
    .line 1088
    invoke-static {}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m()Ljava/nio/file/FileVisitOption;
    ...
    .line 1089
    :goto_0
    invoke-static {p0, p3, p2, p1}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;Ljava/util/Set;ILjava/nio/file/FileVisitor;)Ljava/nio/file/Path;

...
.method private final configureConfig(Landroid/graphics/BitmapFactory$Options;Lcoil3/decode/ExifData;)V
    ...
    invoke-static {p1}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap$Config;

    move-result-object p2

    invoke-static {}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m()Landroid/graphics/Bitmap$Config;

    move-result-object v1

    if-ne p2, v1, :cond_3

    invoke-static {}, Lcoil3/size/ScaleDrawable$$ExternalSyntheticApiModelOutline0;->m$1()Landroid/graphics/Bitmap$Config;
...
.method private final decode(Landroid/graphics/BitmapFactory$Options;)Lcoil3/decode/DecodeResult;
    ...
    invoke-static {p1, v6}, Lcoil3/decode/BitmapFactoryDecoder$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/BitmapFactory$Options;Landroid/graphics/ColorSpace;)V
...
.method public decode(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_1
    :try_start_1
    new-instance v2, Lcoil3/decode/BitmapFactoryDecoder$$ExternalSyntheticLambda4;

    invoke-direct {v2, v5}, Lcoil3/decode/BitmapFactoryDecoder$$ExternalSyntheticLambda4;-><init>(Lcoil3/decode/BitmapFactoryDecoder;)V

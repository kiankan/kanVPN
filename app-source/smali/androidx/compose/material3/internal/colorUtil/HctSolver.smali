...
.method private final findResultByJ(DDD)I
    ...
    const-wide v29, 0x4095ec0000000000L    # 1403.0

    move-wide/from16 v31, v1

    div-double v1, v25, v29

    const-wide v25, 0x408bd80000000000L    # 891.0
    ...
    div-double v4, v25, v29

    const-wide v25, 0x406b800000000000L    # 220.0

    mul-double v10, v10, v25

    sub-double v10, v31, v10

    const-wide v25, 0x40b89c0000000000L    # 6300.0
    ...
    .line 639
    invoke-direct {v0, v10, v11}, Landroidx/compose/material3/internal/colorUtil/HctSolver;->inverseChromaticAdaptation(D)D
    ...
    aget-wide v31, v11, v30

    mul-double v31, v31, v8

    add-double v35, v25, v31
    ...
    aget-wide v25, v10, v29

    mul-double v4, v4, v25

    add-double/2addr v1, v4

    aget-wide v4, v10, v30

    mul-double/2addr v8, v4

    add-double v39, v1, v8

    cmpg-double v1, v35, v21
    ...
    .line 664
    :cond_6
    sget-object v34, Landroidx/compose/material3/internal/colorUtil/CamUtils;->INSTANCE:Landroidx/compose/material3/internal/colorUtil/CamUtils;

    invoke-virtual/range {v34 .. v40}, Landroidx/compose/material3/internal/colorUtil/CamUtils;->argbFromLinrgbComponents(DDD)I

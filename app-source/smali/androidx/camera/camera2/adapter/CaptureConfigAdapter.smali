...
.method public final mapToRequest-nAberiA(Landroidx/camera/core/impl/CaptureConfig;ILandroidx/camera/core/impl/Config;Ljava/util/List;)Landroidx/camera/camera2/pipe/Request;
    ...
    iget-object v4, p0, Landroidx/camera/camera2/adapter/CaptureConfigAdapter;->threads:Landroidx/camera/camera2/impl/UseCaseThreads;

    invoke-virtual {v4}, Landroidx/camera/camera2/impl/UseCaseThreads;->getSequentialExecutor()Ljava/util/concurrent/Executor;

    move-result-object v4

    invoke-virtual {v0, v3, v4}, Landroidx/camera/camera2/impl/CameraCallbackMap;->addCaptureCallback(Landroidx/camera/core/impl/CameraCaptureCallback;Ljava/util/concurrent/Executor;)V
    ...
    .line 103
    invoke-virtual {v3, v2}, Landroidx/camera/camera2/impl/Camera2ImplConfig$Builder;->insertAllOptions(Landroidx/camera/core/impl/Config;)Landroidx/camera/camera2/impl/Camera2ImplConfig$Builder;

    .line 106
    sget-object p3, Landroidx/camera/core/impl/CaptureConfig;->OPTION_ROTATION:Landroidx/camera/core/impl/Config$Option;

    invoke-interface {v2, p3}, Landroidx/camera/core/impl/Config;->containsOption(Landroidx/camera/core/impl/Config$Option;)Z
    ...
    const-string v4, "JPEG_ORIENTATION"
    ...
    .line 107
    invoke-virtual {v3, p3, v4}, Landroidx/camera/camera2/impl/Camera2ImplConfig$Builder;->setCaptureRequestOption(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Landroidx/camera/camera2/impl/Camera2ImplConfig$Builder;
    ...
    .line 113
    invoke-virtual {v3, p3, v2}, Landroidx/camera/camera2/impl/Camera2ImplConfig$Builder;->setCaptureRequestOption(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Landroidx/camera/camera2/impl/Camera2ImplConfig$Builder;
    ...
    .line 124
    iget-object v2, p0, Landroidx/camera/camera2/adapter/CaptureConfigAdapter;->zslControl:Landroidx/camera/camera2/adapter/ZslControl;

    invoke-interface {v2}, Landroidx/camera/camera2/adapter/ZslControl;->isZslDisabledByUserCaseConfig()Z
    ...
    invoke-interface {v2}, Landroidx/camera/camera2/adapter/ZslControl;->isZslDisabledByFlashMode()Z
    ...
    invoke-interface {v2}, Landroidx/camera/camera2/adapter/ZslControl;->dequeueImageFromBuffer()Landroidx/camera/core/ImageProxy;
    ...
    .line 130
    instance-of v5, v4, Landroidx/camera/camera2/adapter/CaptureResultAdapter;
    ...
    invoke-interface {v2}, Landroidx/camera/core/ImageProxy;->getImage()Landroid/media/Image;
    ...
    invoke-direct {v5, v6}, Landroidx/camera/camera2/pipe/media/AndroidImage;-><init>(Landroid/media/Image;)V

    .line 134
    check-cast v4, Landroidx/camera/camera2/adapter/CaptureResultAdapter;

    const-class v6, Landroidx/camera/camera2/pipe/FrameInfo;

    invoke-static {v6}, Lkotlin/jvm/internal/Reflection;->getOrCreateKotlinClass(Ljava/lang/Class;)Lkotlin/reflect/KClass;

    move-result-object v6

    invoke-virtual {v4, v6}, Landroidx/camera/camera2/adapter/CaptureResultAdapter;->unwrapAs(Lkotlin/reflect/KClass;)Ljava/lang/Object;
    ...
    .line 135
    new-instance v6, Landroidx/camera/camera2/pipe/InputRequest;

    check-cast v5, Landroidx/camera/camera2/pipe/media/ImageWrapper;

    invoke-direct {v6, v5, v4}, Landroidx/camera/camera2/pipe/InputRequest;-><init>(Landroidx/camera/camera2/pipe/media/ImageWrapper;Landroidx/camera/camera2/pipe/FrameInfo;)V

    .line 142
    invoke-direct {p0, v2}, Landroidx/camera/camera2/adapter/CaptureConfigAdapter;->buildImageClosingRequestListener(Landroidx/camera/core/ImageProxy;)Landroidx/camera/camera2/pipe/Request$Listener;
    ...
    iget-boolean v2, p0, Landroidx/camera/camera2/adapter/CaptureConfigAdapter;->isLegacyDevice:Z

    invoke-virtual {p3, p1, p2, v2}, Landroidx/camera/camera2/adapter/CaptureConfigAdapter$Companion;->getStillCaptureTemplate-CMLptTo$camera_camera2(Landroidx/camera/core/impl/CaptureConfig;IZ)I

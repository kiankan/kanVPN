...
.method private final toCamera2ImplConfig(Landroidx/camera/core/impl/SessionConfig;)Landroidx/camera/camera2/impl/Camera2ImplConfig;
    ...
    const-string v0, "getImplementationOptions(...)"
...
.method public final create-79VDu0o(ILandroidx/camera/core/impl/SessionConfig;ZLandroidx/camera/camera2/adapter/GraphStateToCameraStateAdapter;Ljava/lang/Integer;Ljava/util/Map;Ljava/util/Map;)Landroidx/camera/camera2/impl/CameraGraphConfigProvider$CameraGraphCreationResult;
    ...
    const-string/jumbo v4, "surfaceToStreamUseCaseMap"

    invoke-static {v2, v4}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    const-string/jumbo v4, "surfaceToStreamUseHintMap"
    ...
    invoke-static {v8, v4}, Landroidx/camera/camera2/pipe/CameraGraph$OperatingMode;->equals-impl0(II)Z
    ...
    .line 122
    iget-object v15, v0, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->cameraInteropStateCallbackRepository:Landroidx/camera/camera2/impl/CameraInteropStateCallbackRepository;

    if-eqz v15, :cond_0

    invoke-virtual {v15, v1}, Landroidx/camera/camera2/impl/CameraInteropStateCallbackRepository;->updateCallbacks(Landroidx/camera/core/impl/SessionConfig;)V
    ...
    .line 127
    :cond_1
    iget-object v15, v0, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->templateParamsOverride:Landroidx/camera/camera2/compat/workaround/TemplateParamsOverride;
    ...
    invoke-interface {v15, v12}, Landroidx/camera/camera2/compat/workaround/TemplateParamsOverride;->getOverrideParams-xlOpshk(Landroidx/camera/camera2/pipe/RequestTemplate;)Ljava/util/Map;
    ...
    invoke-static {v12}, Landroidx/camera/camera2/impl/Camera2ImplConfigKt;->toParameters(Landroidx/camera/core/impl/Config;)Ljava/util/Map;
    ...
    .line 129
    sget-object v12, Landroidx/camera/camera2/pipe/CameraGraph$OperatingMode;->Companion:Landroidx/camera/camera2/pipe/CameraGraph$OperatingMode$Companion;

    invoke-virtual {v12}, Landroidx/camera/camera2/pipe/CameraGraph$OperatingMode$Companion;->getEXTENSION-2uNL3no()I

    move-result v12

    invoke-static {v8, v12}, Landroidx/camera/camera2/pipe/CameraGraph$OperatingMode;->equals-impl0(II)Z
    ...
    invoke-virtual {v12}, Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;->getCamera2ExtensionMode()Landroidx/camera/camera2/pipe/Metadata$Key;
    ...
    invoke-virtual {v12, v14}, Landroidx/camera/camera2/impl/Camera2ImplConfig;->getPhysicalCameraId(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 141
    :goto_1
    invoke-virtual/range {v18 .. v18}, Landroidx/camera/core/impl/SessionConfig$OutputConfig;->getDynamicRange()Landroidx/camera/core/DynamicRange;
    ...
    .line 142
    invoke-virtual/range {v18 .. v18}, Landroidx/camera/core/impl/SessionConfig$OutputConfig;->getMirrorMode()I

    move-result v8

    .line 144
    sget-object v23, Landroidx/camera/camera2/pipe/OutputStream$Config;->Companion:Landroidx/camera/camera2/pipe/OutputStream$Config$Companion;

    .line 145
    invoke-direct {v0, v7}, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->toDynamicRangeProfile--zsJmt4(Landroidx/camera/core/DynamicRange;)Landroidx/camera/camera2/pipe/OutputStream$DynamicRangeProfile;
    ...
    .line 147
    invoke-virtual {v13}, Landroidx/camera/core/impl/DeferrableSurface;->getPrescribedStreamFormat()I

    move-result v9

    invoke-static {v9}, Landroidx/camera/camera2/pipe/StreamFormat;->constructor-impl(I)I
    ...
    .line 152
    :cond_4
    sget-object v9, Landroidx/camera/camera2/pipe/CameraId;->Companion:Landroidx/camera/camera2/pipe/CameraId$Companion;
    ...
    .line 159
    invoke-static {v9}, Landroidx/camera/camera2/pipe/OutputStream$MirrorMode;->constructor-impl(I)I
    ...
    invoke-virtual {v8}, Landroidx/camera/core/impl/DeferrableSurface;->getContainerClass()Ljava/lang/Class;
    ...
    sget-object v8, Landroidx/camera/camera2/pipe/OutputStream$OutputType;->Companion:Landroidx/camera/camera2/pipe/OutputStream$OutputType$Companion;

    invoke-virtual {v8}, Landroidx/camera/camera2/pipe/OutputStream$OutputType$Companion;->getMEDIA_CODEC()Landroidx/camera/camera2/pipe/OutputStream$OutputType;
    ...
    invoke-virtual {v8}, Landroidx/camera/camera2/pipe/OutputStream$OutputType$Companion;->getSURFACE_VIEW()Landroidx/camera/camera2/pipe/OutputStream$OutputType;
    ...
    invoke-virtual {v8}, Landroidx/camera/camera2/pipe/OutputStream$OutputType$Companion;->getSURFACE_TEXTURE()Landroidx/camera/camera2/pipe/OutputStream$OutputType;
    ...
    invoke-virtual {v8}, Landroidx/camera/camera2/pipe/OutputStream$OutputType$Companion;->getSURFACE()Landroidx/camera/camera2/pipe/OutputStream$OutputType;
    ...
    .line 189
    iget-object v8, v0, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->cameraMetadata:Landroidx/camera/camera2/pipe/CameraMetadata;

    .line 186
    invoke-direct {v0, v13, v2, v8}, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->getStreamUseCase-MhLBY4I(Landroidx/camera/core/impl/DeferrableSurface;Ljava/util/Map;Landroidx/camera/camera2/pipe/CameraMetadata;)Landroidx/camera/camera2/pipe/OutputStream$StreamUseCase;
    ...
    .line 196
    invoke-direct {v0, v13, v3}, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->getStreamUseHint-kVKJKLA(Landroidx/camera/core/impl/DeferrableSurface;Ljava/util/Map;)Landroidx/camera/camera2/pipe/OutputStream$StreamUseHint;
    ...
    .line 144
    invoke-static/range {v23 .. v35}, Landroidx/camera/camera2/pipe/OutputStream$Config$Companion;->create-vBYXiEU$default(Landroidx/camera/camera2/pipe/OutputStream$Config$Companion;Landroid/util/Size;ILjava/lang/String;Landroidx/camera/camera2/pipe/OutputStream$OutputType;Landroidx/camera/camera2/pipe/OutputStream$MirrorMode;Landroidx/camera/camera2/pipe/OutputStream$TimestampBase;Landroidx/camera/camera2/pipe/OutputStream$DynamicRangeProfile;Landroidx/camera/camera2/pipe/OutputStream$StreamUseCase;Landroidx/camera/camera2/pipe/OutputStream$StreamUseHint;Ljava/util/List;ILjava/lang/Object;)Landroidx/camera/camera2/pipe/OutputStream$Config;

    move-result-object v7

    .line 201
    invoke-virtual/range {v18 .. v18}, Landroidx/camera/core/impl/SessionConfig$OutputConfig;->getSharedSurfaces()Ljava/util/List;
    ...
    invoke-static {v8, v13}, Lkotlin/collections/CollectionsKt;->plus(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 203
    sget-object v14, Landroidx/camera/camera2/pipe/CameraStream$Config;->Companion:Landroidx/camera/camera2/pipe/CameraStream$Config$Companion;

    move/from16 v2, v19

    const/4 v3, 0x0

    invoke-static {v14, v7, v3, v2, v3}, Landroidx/camera/camera2/pipe/CameraStream$Config$Companion;->create$default(Landroidx/camera/camera2/pipe/CameraStream$Config$Companion;Landroidx/camera/camera2/pipe/OutputStream$Config;Landroidx/camera/camera2/pipe/ImageSourceConfig;ILjava/lang/Object;)Landroidx/camera/camera2/pipe/CameraStream$Config;
    ...
    .line 205
    invoke-virtual/range {v18 .. v18}, Landroidx/camera/core/impl/SessionConfig$OutputConfig;->getSurfaceGroupId()I
    ...
    new-array v7, v3, [Landroidx/camera/camera2/pipe/CameraStream$Config;
    ...
    .line 214
    iget-object v2, v0, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->zslControl:Landroidx/camera/camera2/adapter/ZslControl;

    invoke-static {v9}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-interface {v2, v9, v1}, Landroidx/camera/camera2/adapter/ZslControl;->isZslSurface(Landroidx/camera/core/impl/DeferrableSurface;Landroidx/camera/core/impl/SessionConfig;)Z
    ...
    .line 225
    invoke-virtual {v14}, Landroidx/camera/camera2/pipe/CameraStream$Config;->getOutputs()Ljava/util/List;
    ...
    .line 222
    invoke-direct {v2, v14, v9, v3, v7}, Landroidx/camera/camera2/pipe/InputStream$Config;-><init>(Landroidx/camera/camera2/pipe/CameraStream$Config;IILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-direct {v0, v2, v4}, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->createCameraGraphFlags(Landroidx/camera/camera2/compat/quirk/CameraQuirks;Z)Landroidx/camera/camera2/pipe/CameraGraph$Flags;
    ...
    .line 252
    sget-object v4, Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;->INSTANCE:Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;

    invoke-virtual {v4}, Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;->getIgnore3ARequiredParameters()Landroidx/camera/camera2/pipe/Metadata$Key;
    ...
    invoke-virtual {v4}, Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;->getCamera2CaptureRequestTag()Landroidx/camera/camera2/pipe/Metadata$Key;
    ...
    invoke-virtual {v2, v3}, Landroidx/camera/camera2/impl/Camera2ImplConfig;->getPhysicalCameraId(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 290
    invoke-static {v2, v10}, Landroidx/camera/camera2/interop/Camera2CaptureRequestConfiguratorKt;->configureWithUnchecked(Landroidx/camera/camera2/interop/Camera2CaptureRequestConfigurator;Ljava/util/Map;)V
    ...
    .line 306
    new-array v3, v3, [Landroidx/camera/camera2/pipe/Request$Listener;

    iget-object v8, v0, Landroidx/camera/camera2/impl/CameraGraphConfigProvider;->callbackMap:Landroidx/camera/camera2/impl/CameraCallbackMap;

...
.method static synthetic awaitSetupCompletion$suspendImpl(Landroidx/camera/camera2/impl/UseCaseSurfaceManager;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p1, v0, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$awaitSetupCompletion$1;->label:I

    sub-int/2addr p1, v2

    iput p1, v0, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$awaitSetupCompletion$1;->label:I
...
.method private final getSurfaces(Ljava/util/List;JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p0, v0, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$getSurfaces$1;->label:I

    sub-int/2addr p0, v2

    iput p0, v0, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$getSurfaces$1;->label:I
    ...
    invoke-direct {p0, p1, v1}, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$getSurfaces$2;-><init>(Ljava/util/List;Lkotlin/coroutines/Continuation;)V

    check-cast p0, Lkotlin/jvm/functions/Function2;

    iput v2, v0, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$getSurfaces$1;->label:I
...
.method private final setSurfaceListener()V
    ...
    check-cast p0, Landroidx/camera/camera2/pipe/CameraSurfaceManager$SurfaceListener;
...
.method private final tryClearSurfaceListener()V
    ...
    check-cast v2, Landroidx/camera/camera2/pipe/CameraSurfaceManager$SurfaceListener;

    invoke-virtual {v1, v2}, Landroidx/camera/camera2/pipe/CameraSurfaceManager;->removeListener(Landroidx/camera/camera2/pipe/CameraSurfaceManager$SurfaceListener;)V
...
.method public onSurfaceActive(Landroid/view/Surface;)V
    ...
    const-string v0, "getDeferrableSurface(...)"
...
.method public final setupAsync(Landroidx/camera/camera2/pipe/CameraGraph;Landroidx/camera/camera2/adapter/SessionConfigAdapter;Ljava/util/Map;J)Lkotlinx/coroutines/Deferred;
    ...
    .line 84
    :cond_0
    iget-object v2, v2, Landroidx/camera/camera2/impl/UseCaseSurfaceManager;->threads:Landroidx/camera/camera2/impl/UseCaseThreads;

    invoke-virtual {v2}, Landroidx/camera/camera2/impl/UseCaseThreads;->getScope()Lkotlinx/coroutines/CoroutineScope;

    move-result-object v2

    new-instance v3, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$setupAsync$1$4;

    const/4 v4, 0x0

    invoke-direct {v3, v1, v0, v4}, Landroidx/camera/camera2/impl/UseCaseSurfaceManager$setupAsync$1$4;-><init>(Landroidx/camera/camera2/adapter/SessionConfigAdapter;Landroidx/camera/core/impl/DeferrableSurface$SurfaceClosedException;Lkotlin/coroutines/Continuation;)V

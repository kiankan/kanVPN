...
.method private constructor <init>(Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;Landroidx/camera/camera2/pipe/core/Threads;ILjava/util/Map;Ljava/util/Map;Landroidx/camera/camera2/pipe/StreamGraph;Landroidx/camera/camera2/pipe/StrictMode;Z)V
    ...
    const-string/jumbo v2, "streamToSurfaceMap"

    invoke-static {p4, v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    const-string/jumbo v2, "outputToSurfaceMap"
...
.method private final awaitRepeatingRequestStarted(Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequence;)V
    ...
    const-string v2, "Waiting for the last repeating request sequence: "
    ...
    new-instance v2, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor$awaitRepeatingRequestStarted$2;

    const/4 v3, 0x0

    invoke-direct {v2, p1, v3}, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor$awaitRepeatingRequestStarted$2;-><init>(Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequence;Lkotlin/coroutines/Continuation;)V

    check-cast v2, Lkotlin/jvm/functions/Function1;

    const-wide/16 v3, 0x7d0

    invoke-virtual {v0, v3, v4, v2}, Landroidx/camera/camera2/pipe/core/Threads;->runBlockingCheckedOrNull(JLkotlin/jvm/functions/Function1;)Ljava/lang/Object;
...
.method private final buildSurfaceMaps(Ljava/util/List;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Z
    ...
    const-string p1, "build(...) should never be called with an empty request list!"
...
.method private final validateRequestList(Ljava/util/List;Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;)Z
    ...
    .line 459
    invoke-virtual {v2}, Landroidx/camera/camera2/pipe/Request;->getStreams()Ljava/util/List;
    ...
    check-cast v4, Landroidx/camera/camera2/pipe/StreamId;

    invoke-virtual {v4}, Landroidx/camera/camera2/pipe/StreamId;->unbox-impl()I

    .line 460
    iget-object v4, p0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->streamGraph:Landroidx/camera/camera2/pipe/StreamGraph;

    invoke-interface {v4}, Landroidx/camera/camera2/pipe/StreamGraph;->getOutputs()Ljava/util/List;
    ...
    check-cast v2, Landroidx/camera/camera2/pipe/StreamId;

    invoke-virtual {v2}, Landroidx/camera/camera2/pipe/StreamId;->unbox-impl()I

    .line 483
    iget-object v2, p0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->streamGraph:Landroidx/camera/camera2/pipe/StreamGraph;

    invoke-interface {v2}, Landroidx/camera/camera2/pipe/StreamGraph;->getOutputs()Ljava/util/List;
    ...
    .line 484
    invoke-interface {v3}, Landroidx/camera/camera2/pipe/OutputStream;->getStreamUseCase-8x2ez34()Landroidx/camera/camera2/pipe/OutputStream$StreamUseCase;
    ...
    .line 485
    invoke-interface {v3}, Landroidx/camera/camera2/pipe/OutputStream;->getStreamUseHint-HIPxoCc()Landroidx/camera/camera2/pipe/OutputStream$StreamUseHint;
    ...
    :cond_f
    invoke-virtual {v3}, Landroidx/camera/camera2/pipe/OutputStream$StreamUseHint;->unbox-impl()J
    ...
    .line 504
    invoke-interface {v1}, Landroidx/camera/camera2/pipe/OutputStream;->isValidForHighSpeedOperatingMode()Z
...
.method public bridge synthetic build(ZLjava/util/List;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Landroidx/camera/camera2/pipe/CaptureSequence$CaptureSequenceListener;Ljava/util/List;)Landroidx/camera/camera2/pipe/CaptureSequence;
    ...
    check-cast p0, Landroidx/camera/camera2/pipe/CaptureSequence;
...
.method public build(ZLjava/util/List;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Landroidx/camera/camera2/pipe/CaptureSequence$CaptureSequenceListener;Ljava/util/List;)Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequence;
    ...
    const-string v2, "graphParameters"

    invoke-static {v5, v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    const-string/jumbo v2, "requiredParameters"

    invoke-static {v6, v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V

    const-string/jumbo v2, "sequenceListener"
    ...
    .line 134
    iget-object v10, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->session:Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;

    invoke-direct {v0, v1, v10}, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->validateRequestList(Ljava/util/List;Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;)Z
    ...
    invoke-direct {v0, v1, v7, v8, v10}, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->buildSurfaceMaps(Ljava/util/List;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Z
    ...
    const-string v13, "Building CaptureRequest for "
    ...
    .line 147
    :cond_2
    invoke-virtual {v1}, Landroidx/camera/camera2/pipe/Request;->getTemplate-ejQnlcg()Landroidx/camera/camera2/pipe/RequestTemplate;

    move-result-object v11

    if-eqz v11, :cond_3

    invoke-virtual {v11}, Landroidx/camera/camera2/pipe/RequestTemplate;->unbox-impl()I
    ...
    :cond_3
    iget v11, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->template:I

    .line 148
    :goto_1
    invoke-direct {v0, v1, v11}, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->buildCaptureRequestBuilder-0UCm73U(Landroidx/camera/camera2/pipe/Request;I)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    .line 151
    :cond_4
    sget-object v13, Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;->INSTANCE:Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;

    invoke-virtual {v13}, Landroidx/camera/camera2/pipe/compat/CameraPipeKeys;->getCamera2CaptureRequestTag()Landroidx/camera/camera2/pipe/Metadata$Key;
    ...
    .line 153
    :cond_5
    invoke-virtual {v12, v13}, Landroid/hardware/camera2/CaptureRequest$Builder;->setTag(Ljava/lang/Object;)V

    .line 157
    invoke-virtual {v1}, Landroidx/camera/camera2/pipe/Request;->getStreams()Ljava/util/List;
    ...
    .line 158
    invoke-virtual/range {v19 .. v19}, Landroidx/camera/camera2/pipe/Request;->getStreams()Ljava/util/List;
    ...
    .line 160
    invoke-virtual {v12, v1}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V
    ...
    .line 170
    invoke-virtual/range {v19 .. v19}, Landroidx/camera/camera2/pipe/Request;->getInputRequest()Landroidx/camera/camera2/pipe/InputRequest;
    ...
    .line 171
    iget-object v1, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->imageWriter:Landroidx/camera/camera2/pipe/media/ImageWriterWrapper;
    ...
    invoke-virtual {v1}, Landroidx/camera/camera2/pipe/InputRequest;->getImage()Landroidx/camera/camera2/pipe/media/ImageWrapper;

    move-result-object v1

    .line 178
    iget-object v13, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->lock:Ljava/lang/Object;

    monitor-enter v13

    .line 179
    :try_start_0
    iget-boolean v14, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->disconnected:Z
    ...
    .line 186
    :goto_3
    iget-object v2, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->imageWriter:Landroidx/camera/camera2/pipe/media/ImageWriterWrapper;

    invoke-interface {v2, v1}, Landroidx/camera/camera2/pipe/media/ImageWriterWrapper;->queueInputImage(Landroidx/camera/camera2/pipe/media/ImageWrapper;)Z
    ...
    const-string v1, " for reprocessing to ImageWriter "
    ...
    .line 194
    :cond_e
    invoke-virtual/range {v19 .. v19}, Landroidx/camera/camera2/pipe/Request;->getParameters()Ljava/util/Map;

    move-result-object v1

    invoke-static {v12, v1}, Landroidx/camera/camera2/pipe/RequestsKt;->writeParameters(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;)V
    ...
    .line 197
    invoke-static {v12, v4}, Landroidx/camera/camera2/pipe/RequestsKt;->writeParameters(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;)V

    .line 200
    invoke-static {v12, v5}, Landroidx/camera/camera2/pipe/RequestsKt;->writeParameters(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;)V
    ...
    .line 215
    invoke-static {v12, v6}, Landroidx/camera/camera2/pipe/RequestsKt;->writeParameters(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;)V
    ...
    .line 223
    iget-object v13, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->session:Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;

    instance-of v14, v13, Landroidx/camera/camera2/pipe/compat/CameraConstrainedHighSpeedCaptureSessionWrapper;

    if-eqz v14, :cond_1a

    .line 225
    check-cast v13, Landroidx/camera/camera2/pipe/compat/CameraConstrainedHighSpeedCaptureSessionWrapper;

    invoke-interface {v13, v2}, Landroidx/camera/camera2/pipe/compat/CameraConstrainedHighSpeedCaptureSessionWrapper;->createHighSpeedRequestList(Landroid/hardware/camera2/CaptureRequest;)Ljava/util/List;
    ...
    sget-object v22, Landroidx/camera/camera2/pipe/OutputStream$StreamUseCase;->Companion:Landroidx/camera/camera2/pipe/OutputStream$StreamUseCase$Companion;

    move-object/from16 v24, v1

    move-object/from16 v23, v2

    invoke-virtual/range {v22 .. v22}, Landroidx/camera/camera2/pipe/OutputStream$StreamUseCase$Companion;->getVIDEO_RECORD-vrKr8v8()J
    ...
    .line 263
    iget-object v4, v0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->session:Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;
    ...
    .line 244
    iget-object v2, v15, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->session:Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;
    ...
    .line 300
    iget-object v1, v15, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->session:Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;
...
.method public submit(Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequence;)Ljava/lang/Integer;
    ...
    instance-of v2, v2, Landroidx/camera/camera2/pipe/compat/CameraConstrainedHighSpeedCaptureSessionWrapper;
    ...
    .line 326
    iget-boolean v2, p0, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->awaitRepeatingRequestOnDisconnect:Z
    ...
    .line 329
    invoke-interface {p0, p1, v1}, Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;->setRepeatingRequest(Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;)Ljava/lang/Integer;

...
.method private final configure(Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;)V
    ...
    const-string v5, "activeStreamSurfaceMap"
    ...
    const-string v6, "activeOutputSurfaceMap"
...
.method private final tryCreateCaptureSession(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget p1, v3, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$tryCreateCaptureSession$1;->label:I

    sub-int/2addr p1, v5

    iput p1, v3, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$tryCreateCaptureSession$1;->label:I
    ...
    .line 546
    iget-object v7, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->lock:Ljava/lang/Object;

    monitor-enter v7

    .line 547
    :try_start_0
    iget-object v8, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->state:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

    sget-object v9, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->PENDING:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;
    ...
    :cond_3
    :try_start_1
    iget-object v8, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->_surfaceMap:Ljava/util/Map;

    iput-object v8, p1, Lkotlin/jvm/internal/Ref$ObjectRef;->element:Ljava/lang/Object;

    .line 552
    iget-object v8, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->_cameraDevice:Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;
    ...
    .line 557
    :cond_4
    sget-object v8, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->CREATING:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

    iput-object v8, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->state:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;
    ...
    iget-object v8, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->timeSource:Landroidx/camera/camera2/pipe/core/TimeSource;

    .line 817
    invoke-interface {v8}, Landroidx/camera/camera2/pipe/core/TimeSource;->now-vQl9yQU()J

    move-result-wide v8

    invoke-static {v8, v9}, Landroidx/camera/camera2/pipe/core/TimestampNs;->box-impl(J)Landroidx/camera/camera2/pipe/core/TimestampNs;

    move-result-object v8

    .line 559
    iput-object v8, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->sessionCreatingTimestamp:Landroidx/camera/camera2/pipe/core/TimestampNs;
    ...
    .line 565
    iget-object v7, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->sessionSequencer:Landroidx/camera/camera2/pipe/compat/SessionSequencer;
    ...
    .line 566
    const-string v9, "Awaiting session lock"
    ...
    invoke-virtual {v7, v3}, Landroidx/camera/camera2/pipe/compat/SessionSequencer;->awaitSessionLock(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    check-cast v7, Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;
    ...
    invoke-interface {v3, v5, v6, p0}, Landroidx/camera/camera2/pipe/compat/CaptureSessionFactory;->create(Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;Ljava/util/Map;Landroidx/camera/camera2/pipe/compat/CaptureSessionState;)Landroidx/camera/camera2/pipe/compat/CaptureSessionFactory$Result;
    ...
    .line 579
    instance-of v5, v3, Landroidx/camera/camera2/pipe/compat/CaptureSessionFactory$Result$Success;
    ...
    sget-object v7, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->CLOSING:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

    if-eq v6, v7, :cond_15

    iget-object v6, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->state:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

    sget-object v7, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->CLOSED:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;
    ...
    sget-object v6, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->CREATING:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

    if-ne v2, v6, :cond_14

    .line 590
    sget-object v1, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->CREATED:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

    iput-object v1, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->state:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

    .line 592
    iget-object v1, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->activeStreamSurfaceMap:Ljava/util/Map;
    ...
    .line 593
    iget-object v1, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->activeOutputSurfaceMap:Ljava/util/Map;
    ...
    .line 595
    check-cast v3, Landroidx/camera/camera2/pipe/compat/CaptureSessionFactory$Result$Success;

    invoke-virtual {v3}, Landroidx/camera/camera2/pipe/compat/CaptureSessionFactory$Result$Success;->getDeferred()Ljava/util/Map;
    ...
    .line 601
    :cond_f
    iput-object v1, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->pendingOutputMap:Ljava/util/Map;
    ...
    .line 609
    iput-object v0, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->pendingSurfaceMap:Ljava/util/Map;
    ...
    .line 617
    invoke-direct {p0, v4}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->configure(Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;)V
...
.method public final configureSurfaceMap(Ljava/util/Map;)V
    ...
    invoke-direct {p1, p0, v2}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$configureSurfaceMap$1$1;-><init>(Landroidx/camera/camera2/pipe/compat/CaptureSessionState;Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$configureSurfaceMap$1$2;

    invoke-direct {v0, p0, p1}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$configureSurfaceMap$1$2;-><init>(Landroidx/camera/camera2/pipe/compat/CaptureSessionState;Lkotlin/coroutines/Continuation;)V
...
.method public final disconnect()V
    ...
    .line 311
    :cond_0
    sget-object v1, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->CLOSING:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;
    ...
    .line 339
    :cond_4
    iget-object v0, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->threads:Landroidx/camera/camera2/pipe/core/Threads;

    new-instance v1, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$disconnect$3;

    invoke-direct {v1, p0, v2}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$disconnect$3;-><init>(Landroidx/camera/camera2/pipe/compat/CaptureSessionState;Lkotlin/coroutines/Continuation;)V
    ...
    .line 376
    iget-object v3, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->cameraGraphFlags:Landroidx/camera/camera2/pipe/CameraGraph$Flags;

    invoke-virtual {v3}, Landroidx/camera/camera2/pipe/CameraGraph$Flags;->getAbortCapturesOnStop()Z
    ...
    .line 377
    iget-object v3, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->threads:Landroidx/camera/camera2/pipe/core/Threads;

    new-instance v6, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$disconnect$9;

    invoke-direct {v6, p0, v0, v2}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$disconnect$9;-><init>(Landroidx/camera/camera2/pipe/compat/CaptureSessionState;Landroidx/camera/camera2/pipe/graph/GraphRequestProcessor;Lkotlin/coroutines/Continuation;)V

    check-cast v6, Lkotlin/jvm/functions/Function1;

    const-wide/16 v7, 0x7d0

    invoke-virtual {v3, v7, v8, v6}, Landroidx/camera/camera2/pipe/core/Threads;->runBlockingCheckedOrNull(JLkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Landroidx/camera/camera2/pipe/compat/Camera2CaptureSequenceProcessor;->disconnect$camera_camera2_pipe()V
    ...
    invoke-virtual {v3}, Landroidx/camera/camera2/pipe/CameraGraph$Flags;->getCloseCaptureSessionOnDisconnect()Z
    ...
    new-instance v6, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$disconnect$12;

    invoke-direct {v6, p0, v1, v2}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$disconnect$12;-><init>(Landroidx/camera/camera2/pipe/compat/CaptureSessionState;Landroidx/camera/camera2/pipe/compat/CaptureSessionState$ConfiguredCameraCaptureSession;Lkotlin/coroutines/Continuation;)V

    check-cast v6, Lkotlin/jvm/functions/Function1;

    invoke-virtual {v3, v4, v5, v6}, Landroidx/camera/camera2/pipe/core/Threads;->runBlockingCheckedOrNull(JLkotlin/jvm/functions/Function1;)Ljava/lang/Object;
...
.method public final getCameraDevice()Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;
    ...
    :try_start_0
    iget-object p0, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->_cameraDevice:Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final getRealtimeCaptureLatency()Landroid/hardware/camera2/CameraExtensionSession$StillCaptureLatency;
    ...
    .line 162
    iget-object p0, p0, Landroidx/camera/camera2/pipe/compat/CaptureSessionState;->cameraCaptureSession:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$ConfiguredCameraCaptureSession;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$ConfiguredCameraCaptureSession;->getSession()Landroidx/camera/camera2/pipe/compat/CameraCaptureSessionWrapper;
    ...
    :goto_0
    instance-of v0, p0, Landroidx/camera/camera2/pipe/compat/AndroidCameraExtensionSession;

    if-eqz v0, :cond_1

    check-cast p0, Landroidx/camera/camera2/pipe/compat/AndroidCameraExtensionSession;
    ...
    .line 163
    invoke-virtual {p0}, Landroidx/camera/camera2/pipe/compat/AndroidCameraExtensionSession;->getRealTimeCaptureLatency()Landroid/hardware/camera2/CameraExtensionSession$StillCaptureLatency;
...
.method public final setCameraDevice(Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;)V
    ...
    invoke-direct {p1, p0, v0}, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$cameraDevice$2$1;-><init>(Landroidx/camera/camera2/pipe/compat/CaptureSessionState;Lkotlin/coroutines/Continuation;)V
...
.method public final shutdown()V
    ...
    .line 452
    sget-object v5, Landroidx/camera/camera2/pipe/CameraGraph$Flags$FinalizeSessionOnCloseBehavior;->Companion:Landroidx/camera/camera2/pipe/CameraGraph$Flags$FinalizeSessionOnCloseBehavior$Companion;

    invoke-virtual {v5}, Landroidx/camera/camera2/pipe/CameraGraph$Flags$FinalizeSessionOnCloseBehavior$Companion;->getIMMEDIATE-Bm6Tfm4()I

    move-result v5

    invoke-static {v1, v5}, Landroidx/camera/camera2/pipe/CameraGraph$Flags$FinalizeSessionOnCloseBehavior;->equals-impl0(II)Z
    ...
    invoke-virtual {v5}, Landroidx/camera/camera2/pipe/CameraGraph$Flags$FinalizeSessionOnCloseBehavior$Companion;->getTIMEOUT-Bm6Tfm4()I
    ...
    .line 463
    sget-object v1, Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;->CLOSED:Landroidx/camera/camera2/pipe/compat/CaptureSessionState$State;

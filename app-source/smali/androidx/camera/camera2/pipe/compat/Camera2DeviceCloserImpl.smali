...
.method private final closeCameraDevice(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/pipe/compat/AndroidCameraState;)V
    ...
    check-cast v4, Landroidx/camera/camera2/pipe/compat/Camera2DeviceCloserImpl;
    ...
    .line 195
    invoke-virtual {p2, v0, v1}, Landroidx/camera/camera2/pipe/compat/AndroidCameraState;->awaitCameraDeviceClosed$camera_camera2_pipe(J)Z
...
.method private final handleQuirksBeforeClosing(Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/pipe/compat/AndroidCameraState;ZZ)Lkotlin/Pair;
    ...
    check-cast p2, Landroidx/camera/camera2/pipe/compat/Camera2DeviceCloser;

    invoke-interface {p1, v1, p2}, Landroidx/camera/camera2/pipe/compat/RetryingCameraStateOpener;->openAndAwaitCameraWithRetry-0r8Bogc(Ljava/lang/String;Landroidx/camera/camera2/pipe/compat/Camera2DeviceCloser;)Landroidx/camera/camera2/pipe/compat/AwaitOpenCameraResult;
...
.method public closeCamera(Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/pipe/compat/AndroidCameraState;Landroidx/camera/camera2/pipe/compat/AudioRestrictionController;ZZ)V
    ...
    invoke-interface {p1, v1}, Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;->unwrapAs(Lkotlin/reflect/KClass;)Ljava/lang/Object;
    ...
    check-cast p2, Landroidx/camera/camera2/pipe/compat/AudioRestrictionController$Listener;

    invoke-interface {p4, p2}, Landroidx/camera/camera2/pipe/compat/AudioRestrictionController;->removeListener(Landroidx/camera/camera2/pipe/compat/AudioRestrictionController$Listener;)V
    ...
    invoke-interface {p6, v0}, Landroidx/camera/camera2/pipe/compat/CameraDeviceWrapper;->unwrapAs(Lkotlin/reflect/KClass;)Ljava/lang/Object;
...
.method public final getThreads()Landroidx/camera/camera2/pipe/core/Threads;
    ...
    .line 48
    iget-object p0, p0, Landroidx/camera/camera2/pipe/compat/Camera2DeviceCloserImpl;->threads:Landroidx/camera/camera2/pipe/core/Threads;
